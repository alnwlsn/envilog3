...
void BH1730::reset() {
    // be sure to have called Wire.begin(); first
    // reset
    write8(BH1730_CMD_SPECIAL | BH1730_CMD_SPECIAL_SOFT_RESET, (1 << 7));
}
...
bool BH1730::measure() {  // just do measurement, but don't calculate the lux
...
uint16_t BH1730::readVis() {
    return read16(BH1730_REG_DATA0_LOW);
}
uint16_t BH1730::readIr() {
    return read16(BH1730_REG_DATA1_LOW);
}
